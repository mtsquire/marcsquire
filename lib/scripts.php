...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_animate', get_template_directory_uri() . '/assets/css/animate.css', false, null);
  wp_enqueue_style('roots_masonry_css', get_template_directory_uri() . '/assets/css/masonry.css', false, null);
  wp_enqueue_style('roots_fancybox', get_template_directory_uri() . '/assets/css/jquery.fancybox.css', false, null);
  ...
  if (is_front_page()){
	wp_register_script('backstretch', get_template_directory_uri() . '/assets/js/backstretch.js', false, null, false);	
  }
