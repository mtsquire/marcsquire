...
<head>
  ...
  <meta name="description" content="Marc Squire is a photographer and web designer currently working in New York City.">
...
<?php if (is_front_page()){ ?>
  <script src="<?php echo get_template_directory_uri(); ?>/assets/js/backstretch.js"></script>
<?php } ?>
